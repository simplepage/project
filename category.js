...
if (productId == 1) {
    document.getElementById("heading").innerHTML = "CATEGORYWOMEN'S";
    document.querySelector(".x1").innerHTML =
        `<div class="image_container"><img src=${data.products[0].womens[0].thumbnail} onclick="myFunc(1)">
        <div class="image_title"><span style="width:150px;">New!<br>${data.products[0].womens[0].title}</span> <span>Rs. ${data.products[0].womens[0].price}</span></div>
        </div>
        
        <div class="image_container"><img src=${data.products[0].womens[1].thumbnail} onclick="myFunc(2)">
        <div class="image_title"><span style="width:150px;">New!<br>${data.products[0].womens[1].title}</span> <span>Rs. ${data.products[0].womens[1].price}</span></div>
        </div>
        
        <div class="image_container"><img src=${data.products[0].womens[2].thumbnail} onclick="myFunc(3)">
        <div class="image_title"><span style="width:150px;">New!<br>${data.products[0].womens[2].title}</span> <span>Rs. ${data.products[0].womens[2].price}</span></div>
        </div>
        
        <div class="image_container"><img src=${data.products[0].womens[3].thumbnail} onclick="myFunc(4)">
        <div class="image_title"><span style="width:150px;">New!<br>${data.products[0].womens[3].title}</span> <span>Rs. ${data.products[0].womens[3].price}</span></div>
        </div>`
}
else if (productId == 2) {
    document.getElementById("heading").innerHTML = "CATEGORYACCESSORIES";
    document.querySelector(".x1").innerHTML = `<div class="image_container"><img src=${data.products[0].accessories[0].thumbnail} onclick="myFunc(5)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].accessories[0].title}</span> <span>Rs. ${data.products[0].accessories[0].price}</span></div>
</div>

<div class="image_container"><img src=${data.products[0].accessories[0].images[1]} onclick="myFunc(6)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].accessories[0].title}</span> <span>Rs. ${data.products[0].accessories[0].price}</span></div>
</div>

<div class="image_container"><img src=${data.products[0].accessories[1].thumbnail} onclick="myFunc(7)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].accessories[1].title}</span> <span>Rs. ${data.products[0].accessories[1].price}</span></div>
</div>

<div class="image_container"><img src=${data.products[0].accessories[2].thumbnail} onclick="myFunc(8)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].accessories[2].title}</span> <span>Rs. ${data.products[0].accessories[2].price}</span></div>
</div>`;
}
else {


    document.getElementById("heading").innerHTML = "CATEGORYMEN'S";
    document.querySelector(".x1").innerHTML = `<div class="image_container"><img src=${data.products[0].mens[0].thumbnail} onclick="myFunc(9)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].mens[0].title}</span> <span>Rs. ${data.products[0].mens[0].price}</span></div>
</div>

<div class="image_container"><img src=${data.products[0].mens[2].thumbnail} onclick="myFunc(10)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].mens[2].title}</span> <span>Rs. ${data.products[0].mens[2].price}</span></div>
</div>

<div class="image_container"><img src=${data.products[0].mens[1].thumbnail} onclick="myFunc(11)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].mens[1].title}</span> <span>Rs. ${data.products[0].mens[1].price}</span></div>
</div>

<div class="image_container"><img src=${data.products[0].mens[0].images[0]} onclick="myFunc(12)">
<div class="image_title"><span style="width:150px;">New!<br>${data.products[0].mens[0].title}</span> <span>Rs. ${data.products[0].mens[0].price}</span></div>
</div>`;
}
