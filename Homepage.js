...
document.querySelector(".data").innerHTML=`<div><img class="data-image image1" src=${data.products[0].womens[0].thumbnail} alt="" onmouseover="changeImage(1,this)" onmouseout="changeImage(2,this)" onclick="myFunction(1)"><br>CATEGORY<br>WOMENS</div><div><img class="data-image" src=${data.products[0].accessories[0].thumbnail} alt="" onmouseover="changeImage(3,this)" onmouseout="changeImage(4,this)" onclick="myFunction(2)"><br>CATEGORY<br>ACCESSORIES</div><div><img class="data-image" src=${data.products[0].mens[0].thumbnail} alt="" onmouseover="changeImage(5,this)" onmouseout="changeImage(6,this)" onclick="myFunction(3)"><br>CATEGORY<br>MEN</div>`;

function changeImage(num,img){
    if(num==1){
        img.src=data.products[0].womens[0].images[3];
    }
    if(num==2){
        img.src=data.products[0].womens[0].thumbnail;
    }
    if(num==3){
        img.src=data.products[0].accessories[0].images[0];
    }
    if(num==4){
        img.src=data.products[0].accessories[0].thumbnail;
    }
    if(num==5){
        img.src=data.products[0].mens[0].images[2];
    }
    if(num==6){
        img.src=data.products[0].mens[0].thumbnail;
    }
}
...
document.querySelector(".scroll1").src=`${data.products[0].mens[0].thumbnail}`;
document.querySelector(".scroll2").src=`${data.products[0].womens[0].thumbnail}`;
document.querySelector(".scroll3").src=`${data.products[0].accessories[0].images[0]}`;
document.querySelector(".scroll4").src=`${data.products[0].accessories[1].images[0]}`;
document.querySelector(".scroll5").src=`${data.products[0].mens[0].images[0]}`;
document.querySelector(".scroll6").src=`${data.products[0].womens[1].thumbnail}`;
document.querySelector(".scroll7").src=`${data.products[0].accessories[1].thumbnail}`;
document.querySelector(".scroll8").src=`${data.products[0].mens[0].images[1]}`;
        ...
        slides.forEach(function(slides,index){
            slides.style.left=`${index*640}px`
        })
        function next(){
            count++;
            if(count==7){
